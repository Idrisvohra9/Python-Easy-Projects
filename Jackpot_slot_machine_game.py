...
def sound(which):
    if which=="spin":
        playsound('D:\\Python work progress\\Python easy projects\\spin.wav')

    elif which=="coin":
        playsound('D:\\Python work progress\\Python easy projects\\coins-handling.wav')

    elif which=="win":
        playsound(playsound('D:\\Python work progress\\Python easy projects\\payout.wav'))
count=1
print("'Enter key' to Spin and 'n' to exit: ")
