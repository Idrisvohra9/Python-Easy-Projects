"""
colors module is a self made custom module that can be imported for the function of adding basic text colors and or text format such as Bold, Italics, Underline, Light or Strikethrough to your code.

Each color can be accessed by calling thier particular name and the first letter of the format.

For example: colornameB for Bold S for strikethrough D for Default U for Underline I for Italics L is for special lighter color substitute for each color.

There are background colors which can be accessed by calling thier specific name and bg as in background for example:
colors.cyanbg()
